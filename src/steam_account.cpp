...
const QString &SteamAccount::getAccountName() const { return account_name; }

void SteamAccount::setAccountName(const QString &accountName) { account_name = accountName; }

const QString &SteamAccount::getPersonalName() const { return personal_name; }

void SteamAccount::setPersonalName(const QString &personalName) { personal_name = personalName; }

const QDateTime &SteamAccount::getLastLogin() const { return last_login; }

void SteamAccount::setLastLogin(const QDateTime &lastLogin) { last_login = lastLogin; }
